...
/*
----Creado----2020-07-16 16:15:02.8307518 -0300 -03 m=+1.259958801
*/
require_once '../core/error_core.php';
require_once '../core/security.php';
require_once '../core/jwt_core.php';
require_once '../core/headers.php';
require_once '../controller/grupos_appsController.php';
...
try {
	...
	$accion = $input->accion;
	$miController = new Grupos_appsController;
	switch ($accion) {
		case "GETALL":
			...
			break;
		case "GETID":
			$result = $miController->getByPrim( $input->idGrupo, $input->idApp);
			$json = json_encode(["ok"=>true,"payload"=> $result]);
			break;
		case "DEL":
			$result = $miController->delByPrim( $input->idGrupo, $input->idApp);
			$json = json_encode(["ok"=>true,"payload"=> $result]);
			break;
	}
